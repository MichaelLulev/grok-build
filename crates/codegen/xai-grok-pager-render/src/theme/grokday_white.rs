//! GrokDay White — GrokDay accents on a white canvas.
//!
//! Same hue family as GrokDay, with a `#ffffff` base, lighter panels,
//! and lighter diff bands. Diff text colors are unchanged.
...
mod palette {
    ...
    pub const BG: Color = rgb(255, 255, 255); // #ffffff — brightest (terminal bg)
    pub const BG_DARK: Color = rgb(240, 240, 240); // #f0f0f0
    pub const BG_STORM_DARK: Color = rgb(246, 246, 246); // #f6f6f6
    pub const BG_STORM: Color = rgb(255, 255, 255); // #ffffff — main bg
    pub const BG_HIGHLIGHT: Color = rgb(240, 240, 240); // #f0f0f0 — highlight bg
    ...
    pub const RED_LIGHT: Color = rgb(254, 234, 238); // #FEEAEE — diff delete bg
    pub const GREEN_LIGHT: Color = rgb(230, 252, 236); // #E6FCEC — diff insert bg
}
use palette::*;

impl Theme {
    pub const fn grokday_white() -> Self {
        Self {
            bg_base: BG_STORM,
            bg_light: BG_HIGHLIGHT,
            bg_dark: rgb(244, 244, 244),
            bg_highlight: BG_HIGHLIGHT,
            bg_hover: rgb(230, 230, 230),
            bg_terminal: BG,
